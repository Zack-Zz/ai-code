...
简明指南和长篇指南中涵盖的所有内容都可以在 GitHub 上找到：`github.com/Zack-Zz/ai-code`
...
*会话存储示例 -> https://github.com/Zack-Zz/ai-code/tree/main/examples/sessions*
...
我已经构建了这些钩子，它们位于仓库的 `github.com/Zack-Zz/ai-code/tree/main/hooks/memory-persistence`
...
我构建了一个实现此功能的持续学习技能：`github.com/Zack-Zz/ai-code/tree/main/skills/continuous-learning`
...
*两份指南中涵盖的所有内容都可以在 GitHub 上的 [ai-code](https://github.com/Zack-Zz/ai-code) 找到*
