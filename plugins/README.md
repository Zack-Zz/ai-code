...
Plugins extend Claude Code with new tools and capabilities. This guide covers installation only - see the [local usage guide](../docs/USAGE.md) for when and why to use them.
