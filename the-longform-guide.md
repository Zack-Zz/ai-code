# The Longform Guide to ai-code

---

> **Prerequisite**: This guide builds on [The Shorthand Guide to ai-code](./the-shortform-guide.md). Read that first if you haven't set up skills, hooks, subagents, MCPs, and plugins.
...
Everything covered in the shorthand and longform guides is available on GitHub: `github.com/Zack-Zz/ai-code`
...
*Example of session storage -> https://github.com/Zack-Zz/ai-code/tree/main/examples/sessions*
...
```bash
# Daily development
alias claude-dev='claude --system-prompt "$(cat $AI_CODE_HOME/contexts/dev.md)"'

# PR review mode
alias claude-review='claude --system-prompt "$(cat $AI_CODE_HOME/contexts/review.md)"'

# Research/exploration mode
alias claude-research='claude --system-prompt "$(cat $AI_CODE_HOME/contexts/research.md)"'
```
...
I've built these hooks and they're in the repo at `github.com/Zack-Zz/ai-code/tree/main/hooks/memory-persistence`
...
I've built a continuous learning skill that does this: `github.com/Zack-Zz/ai-code/tree/main/skills/continuous-learning`
...
*Everything covered in both guides is available on GitHub at [ai-code](https://github.com/Zack-Zz/ai-code)*
