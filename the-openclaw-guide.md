...
> **This is Part 3 of the ai-code guide series.** Part 1 is [The Shorthand Guide](./the-shortform-guide.md) (setup and configuration). Part 2 is [The Longform Guide](./the-longform-guide.md) (advanced patterns and workflows). This guide is about security — specifically, what happens when recursive agent infrastructure treats it as an afterthought.
...
I want to be upfront about my perspective. I build AI coding tools. My ai-code repo has 50K+ stars. I created AgentShield. I spend most of my working hours thinking about how agents should interact with systems, and how those interactions can go wrong.
...
├── Claude Code with ai-code configuration
...
> **Series navigation:**
> - Part 1: [The Shorthand Guide to ai-code](./the-shortform-guide.md) — Setup and configuration
> - Part 2: [The Longform Guide to ai-code](./the-longform-guide.md) — Advanced patterns and workflows
...
*Affaan Mustafa ([@affaanmustafa](https://x.com/affaanmustafa)) builds AI coding tools and writes about AI infrastructure security. His ai-code repo has 50K+ GitHub stars. He created AgentShield and won the Anthropic x Forum Ventures hackathon building [zenith.chat](https://zenith.chat).*
