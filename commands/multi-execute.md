...
| Phase | Codex | Gemini |
|-------|-------|--------|
| Implementation | `$AI_CODE_HOME/.ccg/prompts/codex/architect.md` | `$AI_CODE_HOME/.ccg/prompts/gemini/frontend.md` |
| Review | `$AI_CODE_HOME/.ccg/prompts/codex/reviewer.md` | `$AI_CODE_HOME/.ccg/prompts/gemini/reviewer.md` |
...
1. Call Gemini (use `$AI_CODE_HOME/.ccg/prompts/gemini/frontend.md`)
...
1. Call Codex (use `$AI_CODE_HOME/.ccg/prompts/codex/architect.md`)
2. Input: Plan content + retrieved context + target files
3. OUTPUT: `Unified Diff Patch ONLY. Strictly prohibit any actual modifications.`
