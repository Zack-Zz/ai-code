...
| Phase | Codex | Gemini |
|-------|-------|--------|
| Analysis | `$AI_CODE_HOME/.ccg/prompts/codex/analyzer.md` | `$AI_CODE_HOME/.ccg/prompts/gemini/analyzer.md` |
| Planning | `$AI_CODE_HOME/.ccg/prompts/codex/architect.md` | `$AI_CODE_HOME/.ccg/prompts/gemini/architect.md` |
